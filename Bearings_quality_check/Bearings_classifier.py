#### This Bearings Classifier python script is used to build an interactive GUI using PySimpleGUI for testing
#### This helps to autopopulate images from given valid folder path, Detect and count needles from images having bearing associated in it
...
# creates bearing classifier object which contains the functionality of Bearing detection and needle count
# bearings_classifier is the class contains the bearings detection functionalities
...
while True:
    ...
    if event == "-FOLDER-":
        ...
        try:
            ...
            pass
    # if the detected pins button is presses after the selection of image from the list
